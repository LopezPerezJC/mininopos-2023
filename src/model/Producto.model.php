...
ADMIN
********
create table tiendas(id int not null auto_increment, nombre varchar(100), dirección varchar(150), telefono varchar(12), mail varchar(50), primary key(id));
create table usuarios (id int not null auto_increment, id_tienda int, nombre varchar(100), contrasenia varchar(50), rol varchar(100), img_usuario MEDIUMBLOB, primary key(id), foreign key(id_tienda) references tiendas(id));
...
INSERT INTO usuarios values(1, 1, "Juan Carlos López Pérez", "$P4rr0w5", "super-admin", "");
