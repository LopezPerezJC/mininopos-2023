...
if(isset($_POST['btn-enviar-cuestionario'])){
    $id = null;
    ...
    if($id_tienda != "" && $id_usuario != "" && $respuesta_pregunta_1 != "" && $respuesta_pregunta_2 != "" && $respuesta_pregunta_3 != ""){
            ...
            $insert = $BaseDatos->nuevoCuestionario($id, $id_tienda, $id_usuario, $respuesta_pregunta_1, $respuesta_pregunta_2, $respuesta_pregunta_3, $sugerencia);
            if($insert){
